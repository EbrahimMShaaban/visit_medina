...
class Activities extends StatefulWidget {
  Activities({Key? key, required this.titleAppBar, required this.event}) : super(key: key);
                  ...
                  child: Column(
                    ...
                    children: [
                      AddEventCubit.get(context).postImage != null
                          ...
                          : InkWell(
                              onTap: () async{
                               await AddEventCubit.get(context).getPostImage();
                              },
                              child: Container(
                                height: 150,
                          ...
                          : Container(
                              ...
                              child: ButtonTemplate(
                                  ...
                                  onPressed: () {
                                    ...
                                    if (AddEventCubit.get(context).postImage ==
                                        null) {
                                      MotionToast.error(
